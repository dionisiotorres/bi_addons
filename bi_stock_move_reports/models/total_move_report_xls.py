    ...
    def generate_xlsx_report(self, workbook, data, wizard):
        ...
        if wizard.type == 'all':
            ...
            for move in moves_objs:
                move_row += 1
                worksheet.write(move_row, 0, str(move.date))
                ...
                worksheet.write(move_row, 8, str(move.product_uom_qty))
                worksheet.write(move_row, 9, move.product_uom.name)
                worksheet.write(move_row, 10, str(move.quantity_done))
                worksheet.write(move_row, 11, str(move.value))
                worksheet.write(move_row, 12, move.in_out_flag)
                worksheet.write(move_row, 13, str(move.item_standard_price))
                worksheet.write(move_row, 14, str(move.item_value))
                worksheet.write(move_row, 15, str(move.item_total_cost))
                worksheet.write(move_row, 16, move.transaction_type or ' ')
                worksheet.write(move_row, 17, move.prod_opening_balance)
                worksheet.write(move_row, 18, move.prod_ending_balance)
                worksheet.write(move_row, 19, move.state)
            ...
            worksheet.write(row_no, col_no + 1, wizard.location_id.name, )
            row_no += 2
